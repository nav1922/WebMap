...
const Home = () => {
  ...
  return (
   ...
   <div >
  {/* hero - start */}
  <div className="bg-gray pb-6 sm:pb-8 lg:pb-12 mt-20">
  ...
  {/* hero - end */}
  {/* gallery - start */}
  <div className="bg-gray py-6 sm:py-8 lg:py-12">
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <h2 className="mb-4 text-center text-2xl font-bold text-white-800 md:mb-8 lg:text-3xl xl:mb-12">
        Gallery
      </h2>
      ...
      <div className="flex items-start justify-between gap-8 sm:items-center">
        <p className="max-w-screen-sm text-sm text-white-500 lg:text-base">
  ...
  <div className="bg-gray py-6 sm:py-8 lg:py-12">
    <div className="mx-auto max-w-screen-lg px-4 md:px-8">
      ...
      <div className="mb-8 md:mb-12">
        <h2 className="mb-4 text-center text-2xl font-bold text-white-800 md:mb-6 lg:text-3xl">
          Our Team by the numbers
        </h2>
        <p className="mx-auto max-w-screen-md text-center text-white-500 md:text-lg">
          This is a section of some simple filler text, also known as
          placeholder text. It shares some characteristics of a real written
      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-6 lg:gap-8">
          <div className="col-span-full lg:col-span-2">
            ...
            {/* logo - end */}
            <p className="mb-6 text-white-500 sm:pr-8">
